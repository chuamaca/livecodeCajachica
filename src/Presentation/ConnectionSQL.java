...
public class ConnectionSQL extends javax.swing.JFrame {
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConectarActionPerformed
        ...
        String bases="";
        try {
            Statement sql = Utils.ConnectionSQL.getConexion().createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnectionSQL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
